...
path('administrator/proposals/export/pdf/', views.export_proposals_table_pdf, name='export_proposals_table_pdf'),
...
path('projects/export/pdf/', views.export_projects_table_pdf, name='export_projects_table_pdf'),
path('administrator/forecast/', views.administrator_forecast_view, name='administrator_forecast_url'),
path('administrator/forecast/review/<int:pk>/', views.administrator_forecast_review_update_view, name='administrator_forecast_review_update_url'),
path('projects/<int:pk>/', views.administrator_projects_detail_view, name='administrator_projects_detail_url'),
path('projects/<int:pk>/issue-extension/', views.administrator_project_issue_extension_request_view, name='administrator_project_issue_extension_request_url'),
...
path('notifications/go/<int:pk>/', views.notification_redirect_view, name='notification_redirect'),
...
path('reports/financial-summary/pdf/', views.financial_summary_pdf, name='financial_summary_pdf'),
...
path('proponent/tasks/edit/', views.proponent_task_edit_view, name='proponent_task_edit_url'),
...
path('beneficiary/proposals/add/', views.beneficiary_proposals_add_view, name='beneficiary_proposals_add_url'),
...
path('beneficiary/tasks/edit/', views.beneficiary_task_edit_view, name='beneficiary_task_edit_url'),
